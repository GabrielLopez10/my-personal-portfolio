  ...
  return (
    <div className='space-y-2 pb-8 pt-6 md:space-y-5'>
      <nav className='flex justify-between'>
        ...
        {!nextPage && (
          <button
            className='cursor-auto disabled:opacity-50 text-slate-50'
            disabled={!nextPage}
          >
            Next
          </button>
    ...
    <>
      <SectionContainer>
        ...
        <div className='flex sm:space-x-12'>
          <div className='hidden max-h-screen h-full md:flex flex-wrap bg-gray-50 dark:bg-gray-900/70 shadow-md pt-5 dark:shadow-gray-800/40 rounded min-w-[280px] max-w-[280px] overflow-auto'>
