...
const ContactMe = () => {
  return (
    <AnimationContainer customClassName='w-full'>
      ...
      <div className='w-full flex justify-between items-center flex-col mx-auto max-w-screen-xl pb-5'>

        <div className='w-full flex justify-between items-center flex-col lg:flex-row gap-6 mb-10'>

          <a href='mailto:gastonlopez436@gmail.com' target='_blank' rel='noreferrer' className='w-full'>
