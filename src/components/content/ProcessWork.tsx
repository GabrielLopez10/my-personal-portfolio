...
const ProcessWork = () => {
  return (
    <AnimationContainer customClassName="w-full mb-4">
      <h2 className="mb-12 text-start text-2xl font-bold tracking-tight text-white md:text-2xl">
        My work process
      </h2>

      <div className="mx-auto mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        {myWorkProcess.map(({ id, title, des, delay }) => (
          <AnimationContainer
            ...
            customDelay={delay}
          >
            <h3 className="text-1xl text-start font-bold tracking-tight text-white">{title}</h3>
