...
const AllFavTechs = () => {
  return (
    <>
      <motion.p
        className="mb-2.5 text-center text-base text-gray-400 lg:text-start"
      ...
      <motion.ul
        className="mx-auto flex flex-wrap items-center justify-center gap-3.5 text-[#444]"
        initial="hide"
        animate="show"
      ...
      >
        ...
        <motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
          <div className="grayscale filter transition duration-200 hover:grayscale-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
              fill="currentColor"
            ...
            >
              ...
              <g>
                <path transform="translate(96,96) scale(0.25,0.25)" />
        ...
        <motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
          <div className="transition duration-200 hover:text-[#f06292]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
              width="32px"
            ...
            >
              <title>Sass</title>
              <path d="M24.042,4.032C35.065,4.032,44,12.967,44,23.99 c0,11.022-8.935,19.958-19.958,19.958c-11.022,0-19.958-8.935-19.958-19.958C4.085,12.967,13.02,4.032,24.042,4.032L24.042,4.032z" />
              <path
                fill="#fff"
